...
pub fn parse_lines(input: &str) -> Result<Store, PersistError> {
...
pub fn parse_line(line_no: usize, line: &str) -> Result<Option<Record>, PersistError> {
    let line = line.trim();
...
pub fn parse_record(line_no: usize, line: &str) -> Result<Record, PersistError> {
...
pub fn split_at_first_space(line: &str) -> (&str, &str) {
...
pub fn split_kv_tokens(line_no: usize, rest: &str) -> Result<Vec<String>, PersistError> {
